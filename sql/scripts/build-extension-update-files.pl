...
For example:
File: $PROJECT--3.4.sig works for 3.4.0, 3.4.1 .... 3.4.x
File: $PROJECT--3.5.sig
* Has all the signatures of $PROJECT--3.4.sig and maybe some more
* When IN parameters names or OUT parameters name, type change
  * use drop_special_case_function

TODO review the file when the first upgrade is done
