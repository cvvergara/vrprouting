...
CREATE OR REPLACE FUNCTION vrp_compatibleVehicles(
...
COMMENT ON FUNCTION vrp_compatibleVehicles(TEXT, TEXT, TEXT, TEXT, BIGINT, FLOAT, BOOLEAN)
IS 'vrp_compatibleVehicles
- Documentation:
