...
CREATE OR REPLACE FUNCTION vrp_viewRouteRaw(
  TEXT, -- orders SQL
  TEXT, -- vehicles sql
...
COMMENT ON FUNCTION vrp_viewRouteRaw(TEXT, TEXT, TEXT, TEXT, BIGINT, FLOAT)
IS 'vrp_viewRoute
- Documentation:
  - ${PROJECT_DOC_LINK}/vrp_viewRouteRaw.html
';
