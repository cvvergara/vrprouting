...
``vrp_full_version`` — Get the details of pgOrtools version information.
...
Get the details of pgOrtools version information
...
================  =========== ===============================
``version``       ``TEXT``    pgOrtools version
...
``hash``          ``TEXT``    Git hash of pgOrtools build
================  =========== ===============================
